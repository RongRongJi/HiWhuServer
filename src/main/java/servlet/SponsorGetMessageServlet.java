 ...
 */
public class SponsorGetMessageServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public SponsorGetMessageServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<LeaveMessage> leaveMessageList=leaveMessageDao.getMessageBySponsorID(sponsorID);
        JSONArray array = JSONArray.fromObject(leaveMessageList);
